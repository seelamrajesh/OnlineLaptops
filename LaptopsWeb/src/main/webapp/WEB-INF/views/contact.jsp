...
<body>
 <div class="container">
      <div class=""page-header" > 
        <h1 style="color:blue;"><center> TECHNO WORLD</center></h1>     
      ...
      <img src="C:\Users\RAJESH\Desktop\Images\create_thumb.png" class="img-circle" alt="Cinque Terre" width="100" height="80">
        </div>
         </div>
      ...
      <li><a href="login.in"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
 	  ...
 	  <div class="row">
		        ...
		        <h4>Corporate Address:</h4>
                         ...
                         Email: cs@flipkart.com<br>
                         Person to be contacted: Mr. Krishna Salunke<br>
                         Ph: (0124) 6150000<br>
                        </address>
                   </div>
		</div>
