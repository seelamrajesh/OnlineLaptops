...
<div class="row">
       <center>
	<div class="col-md-12">
	   <p><img src="C:\Users\RAJESH\Desktop\Images\About-us-banner.png" width=1000 height=260 class="pull-center"></p>
	       <div class="col-md-12"><p> 
t is still  and we continue to relentlessly focus on using our investments in technology and innovation to transform the lives of our customers and all our partners. We strive to transform the way India shops and the way India sells. </p></div>
               </div>
	 </div>
</div>
          </style></div>
